...
#D:\Mark\R\Machine-Learning with R\R-with-Machine-learning\Data\US Presidential Data.csv
#https://www.r-bloggers.com/k-nearest-neighbor-step-by-step-tutorial/
path="D:\\Mark\\R\\Machine-Learning with R\\R-with-Machine-learning\\Data\\US Presidential Data.csv"
data1=read.csv(path)
head(data1)
